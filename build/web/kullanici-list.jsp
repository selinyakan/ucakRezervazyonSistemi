...
<header>    
	...
	<div class="row">
		...
		<div class="container">
			<h3 class="text-center">Üye Listesi</h3>
			<hr>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="user" items="${listKullanici}">
						<tr>
							...
							<td><a href="kullaniciDuzenle?id=<c:out value='${user.id}' />">Düzenle</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="kullaniciSil?id=<c:out value='${user.id}' />">Sil</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
