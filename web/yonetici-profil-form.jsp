<%-- 
    Document   : yonetici-profil-form
    Created on : 14.Oca.2021, 21:41:16
    Author     : yAkAn
--%>
					...
					<div class="col">
						...
						<c:if test="${user.cinsiyet != 0}">
							<label>Kadın</label>
                                        ...
                                        <div class="row pt-3">
					<div class="col">
						<a class="btn btn-success" style="background-color: gray" href="yoneticiDuzenle?id=<c:out value='${YONETICI_HESAP.id}' />">Bilgileri Düzenle</a>
					</div>
